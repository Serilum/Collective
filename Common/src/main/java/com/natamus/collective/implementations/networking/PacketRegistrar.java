...
public interface PacketRegistrar {
     ...
     */
    <T> PacketRegistrar registerPacket(Identifier packetIdentifier, Class<T> messageType, BiConsumer<T, FriendlyByteBuf> encoder, Function<FriendlyByteBuf, T> decoder, Consumer<PacketContext<T>> handler);
}
