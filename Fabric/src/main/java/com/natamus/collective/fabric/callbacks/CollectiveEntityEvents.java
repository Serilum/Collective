...
public final class CollectiveEntityEvents {
    ...
    public static final Event<Living_Tick> LIVING_TICK = EventFactory.createArrayBacked(CollectiveEntityEvents.Living_Tick.class, callbacks -> (world, entity) -> {
	...
	public interface Entity_Fall_Damage_Calc {
		 int onFallDamageCalc(Level world, Entity entity, double d, float f);
	}
