...
public class ForgeRegisterItemHelper implements RegisterItemHelper {
    ...
    @Override
	public <T extends Item> void registerItem(Object modEventBusObject, ResourceLocation resourceLocation, Supplier<T> itemSupplier, @Nullable ResourceKey<CreativeModeTab> creativeModeTabResourceKey, boolean lastItem) {
	...
	public static <T extends Item> RegistryObject<Item> staticRegisterItem(Object modEventBusObject, ResourceLocation resourceLocation, Supplier<T> itemSupplier, @Nullable ResourceKey<CreativeModeTab> creativeModeTabResourceKey, boolean lastItem) {
